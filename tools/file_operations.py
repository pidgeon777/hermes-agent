...
class ShellFileOperations(FileOperations):
    ...
    def _escape_native_tool_path(self, path: str) -> str:
        """Quote a path for a native executable launched from Bash.

        Native Windows binaries such as rg.exe require drive-letter paths
        while MSYS argument conversion is disabled. POSIX behavior is unchanged.
        """
        import shlex
